...
trait ERC20Trait<TCS> {
    ...
    fn transfer_from(
        ref self: TCS, serder: ContractAddress, recipient: ContractAddress, amount: u256
    );
...
#[starknet::component]
mod ERC20Component {
    use starknet::{ContractAddress, get_call_address, contract_address_const};
    #[storage]
    struct Storage {
        name: felt252,
        symbol: felt252,
    ...
    > of ERC20HelperTrait<TContractState> {
        fn transfer_helper(
            ...
            assert(!sender.is_zero(), 'ERC: transfer from 0');
